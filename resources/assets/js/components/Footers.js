                ...
                <div className="container-fluid text-center text-md-left">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 mt-md-0 mt-3">
                            ...
                            <p className="text-white">Styly is the pioneer and #1 operator offering the most trusted
                                online saloon & stylist connecting experience in USA</p>
                        ...
                        <div className="col-md-3 mb-md-0 mb-3">
                            ...
                            <ul className="list-unstyled ">
                                ...
                                <li>
                                    <a href="#!" className="text-white">How it work</a>
                                </li>
